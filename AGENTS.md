# papiflyfx-docking-core Agent Guidance
...
- `@core-architect` - Owns `papiflyfx-docking-api`, `papiflyfx-docking-docks`, shared contracts, layout/session behavior, and ribbon shell infrastructure.
